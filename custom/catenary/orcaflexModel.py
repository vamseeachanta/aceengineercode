...
from results.catenary.saveData import saveDataYaml
...
#  Using default settings
    customData = {"StageDuration": data['FEASettings']['Stage'][FEAType]['Duration'],
            "TargetLogSampleInterval": data['FEASettings']['Stage'][FEAType]['TargetLogSampleInterval'],
            "ImplicitConstantTimeStep": data['FEASettings']['Stage'][FEAType]['ImplicitConstantTimeStep']
        }
    model1["General"] = general(customData)

    customData = []
    customData1 = {"Type": "BendingConnectionStiffness",
                "Name": "FJProfile",
                "FlexJointStiffness": data['FEASettings']['FlexJointStiffness'][FEAType]}
    customData2 = {"Type": "LineTypeOuterDiameter",
                "Name": "FJExtension",
                "ProfileLength": data['LazyWaveCatenaryDefinition']['TaperJoint']['L'],
                "ThickEndOD": (data['MainPipe']['SteelSection']['ID'] + 2*data['LazyWaveCatenaryDefinition']['TaperJoint']['ThickendThickness'])*0.0254,
    ...
    customData = {"Density": data['Material']['SeaWater']['Rho']/1000,
                "WaterDepth": data['geometry']['waterDepth'],
                "SeabedNormalStiffness": data['FEASettings']['Seabed']['Stiffness'][FEAType]/((data['MainPipe']['InsulationSection']['OD']+2*data['geometry']['Strakes']['BaseThickness'])*0.0254)}
    ...
    if data['FEASettings']['Damping'][FEAType]['Period1'] == "WavePeriod1":
        if data['EnvironmentLoad'][FEAType][LoadingIndex]['Wave']['WaveTrains'][0]['WaveType'] == "Dean Stream":
            customData = {"Name": data['FEASettings']['Damping'][FEAType]['Name'],
                          "Mode": data['FEASettings']['Damping'][FEAType]['Mode'],
                          "DampingRatio": data['FEASettings']['Damping'][FEAType]['DampingRatio'],
                          "Period1": data['EnvironmentLoad'][FEAType][LoadingIndex]['Wave']['WaveTrains'][0]['WaveTz'],
                          "ApplyToGeometricStiffness": data['FEASettings']['Damping'][FEAType]['ApplyToGeometricStiffness']
                          }
        elif data['EnvironmentLoad'][FEAType][LoadingIndex]['Wave']['WaveTrains'][0]['WaveType'] == "JONSWAP":
            customData = { "Name": data['FEASettings']['Damping'][FEAType]['Name'],
                            "Mode": data['FEASettings']['Damping'][FEAType]['Mode'],
                            "DampingRatio": data['FEASettings']['Damping'][FEAType]['DampingRatio'],
                            "Period1": data['EnvironmentLoad'][FEAType][LoadingIndex]['Wave']['WaveTrains'][0]['WaveTp'],
                            "ApplyToGeometricStiffness": data['FEASettings']['Damping'][FEAType]['ApplyToGeometricStiffness']
                           }
        elif data['EnvironmentLoad'][FEAType][LoadingIndex]['Wave']['WaveTrains'][0]['WaveType'] == "Ochi-Hubble":
            customData = { "Name": data['FEASettings']['Damping'][FEAType]['Name'],
                            "Mode": data['FEASettings']['Damping'][FEAType]['Mode'],
                            "DampingRatio": data['FEASettings']['Damping'][FEAType]['DampingRatio'],
                            "Period1": 1/data['EnvironmentLoad'][FEAType][LoadingIndex]['Wave']['WaveTrains'][0]['Wavefm1'],
                            "ApplyToGeometricStiffness": data['FEASettings']['Damping'][FEAType]['ApplyToGeometricStiffness']
                   }
    else:
        customData = {"Name": data['FEASettings']['Damping'][FEAType]['Name'],
    ...
    model2["RayleighDampingCoefficients"].append(RayleighDampingCoefficients(customData))
    ...
    customData = {
        "Name": "MainPipe",
        "Category": "General",
        "OD": (data['MainPipe']['InsulationSection']['OD'] + 2*data['geometry']['Strakes']['BaseThickness'])*0.0254,
        "ID": data['MainPipe']['SteelSection']['ID']*0.0254,
        "MassPerUnitLength": data['MainPipe']['equivalentPipe']['WithoutBuoyancy']['massPerUnitLength'] / 1000,
        "EI": data['Material']['Steel']['E']* 6.894745 * data['MainPipe']['SteelSection']['I'] * 0.0254**4,
        "EA": data['Material']['Steel']['E']* 6.894745 * data['MainPipe']['SteelSection']['A'] * 0.0254**2,
        "PoissonRatio": data['Material']['Steel']['PoissionsRatio'],
        "GJ": data['Material']['Steel']['G']* 6.894745 *2* data['MainPipe']['SteelSection']['I'] * 0.0254**4,
        ...
        "StressID": data['MainPipe']['SteelSection']['ID']*0.0254 + 2*data['FEASettings']['CorrosionAllowance'][FEAType]*0.0254,
        "SeabedNormalFrictionCoefficient": data['FEASettings']['Seabed']['FrictionCoefficient']['Normal'],
        "SeabedAxialFrictionCoefficient": data['FEASettings']['Seabed']['FrictionCoefficient']['Axial'],
        ...
        "APISTD2RDFd1": data['EnvironmentLoad'][FEAType][LoadingIndex]['CodeChecks']['APISTD2RDFd1'],
        "APISTD2RDFd2": data['EnvironmentLoad'][FEAType][LoadingIndex]['CodeChecks']['APISTD2RDFd2'],
        "APISTD2RDDelta": data['EnvironmentLoad'][FEAType][LoadingIndex]['CodeChecks']['APISTD2RDDelta'],
        "APISTD2RDAlphaFab": data['EnvironmentLoad'][FEAType][LoadingIndex]['CodeChecks']['APISTD2RDAlphaFab'],
        "APISTD2RDk": data['EnvironmentLoad'][FEAType][LoadingIndex]['CodeChecks']['APISTD2RDk'],
        "Pen": [2, "Solid", "Yellow"]
        }
    ...
    customData = {
        ...
        "MassPerUnitLength": data['BuoyPipe']['equivalentPipe']['WithBuoyancy']['massPerUnitLength'] / 1000,
        "EI": data['Material']['Steel']['E']* 6.894745 * data['BuoyPipe']['SteelSection']['I'] * 0.0254**4,
        "EA": data['Material']['Steel']['E']* 6.894745 * data['BuoyPipe']['SteelSection']['A'] * 0.0254**2,
        "PoissonRatio": data['Material']['Steel']['PoissionsRatio'],
        "GJ": data['Material']['Steel']['G']* 6.894745 *2* data['BuoyPipe']['SteelSection']['I'] * 0.0254**4,
        ...
        "StressID": data['BuoyPipe']['SteelSection']['ID']*0.0254 + 2*data['FEASettings']['CorrosionAllowance'][FEAType]*0.0254,
        "SeabedNormalFrictionCoefficient": data['FEASettings']['Seabed']['FrictionCoefficient']['Normal'],
        "SeabedAxialFrictionCoefficient": data['FEASettings']['Seabed']['FrictionCoefficient']['Axial'],
        "CorrosionThickness": 0,
        "SMYS": data['Material']['Steel']['SMYS']*6.894745,
    ...
    # BuoyPipeStartEnd
    customData.update({"Name": "BuoyPipeStartEnd",
        "Cd": data['FEASettings']['Hydrodynamic'][FEAType]['BuoyPipeStartEnd']['Cd'],
        "Ca": data['FEASettings']['Hydrodynamic'][FEAType]['BuoyPipeStartEnd']['Ca'],
    })
    model2["LineTypes"].append(lineTypes(customData))
    # FJExtension
    customData = {
        ...
        "OD": "FJExtension",
        "ID": data['MainPipe']['SteelSection']['ID'] * 0.0254 + 2*data['FEASettings']['CorrosionAllowance'][FEAType]*0.0254,
...
def wave(data, FEAType, LoadingIndex):
    ...
    if data['EnvironmentLoad'][FEAType][LoadingIndex]['Wave']['WaveTrains'][0]['WaveType'] == "Dean Stream":
        ...
        model.update({"WaveTrains": [{"Name": "Wave1", "WaveType": "Dean Stream", "WaveDirection": 180, "WaveHeight": 7, "WavePeriod": 8, "WaveOrigin": [0, 0], "WaveTimeOrigin": 0, "WaveStreamFunctionOrder": 5}] })
    elif data['EnvironmentLoad'][FEAType][LoadingIndex]['Wave']['WaveTrains'][0]['WaveType'] == "JONSWAP":
...
def current(data, FEAType, LoadingIndex):
    model={}
    # Current
    if data['EnvironmentLoad'][FEAType][LoadingIndex]["MultipleCurrentDataCanBeDefined"]:
        model.update({"MultipleCurrentDataCanBeDefined": "Yes"})
        model.update({"Currents": data['EnvironmentLoad'][FEAType][LoadingIndex]['Currents']})
        model.update({"ActiveCurrent": data['EnvironmentLoad'][FEAType][LoadingIndex]['ActiveCurrent']})
    else:
        ...
        model.update({"RefCurrentSpeed": data['EnvironmentLoad'][FEAType][LoadingIndex]['Current']['RefCurrentSpeed']})
        model.update({"RefCurrentDirection": data['EnvironmentLoad'][FEAType][LoadingIndex]['Current']['RefCurrentDirection']})
        model.update({"CurrentDepth, CurrentFactor, CurrentRotation": data['EnvironmentLoad'][FEAType][LoadingIndex]['Current']['CurrentDepth, CurrentFactor, CurrentRotation']})
    return model
...
def lines(data, FEAType, LoadingIndex):
    ...
    if data['default']['Analysis']['SCR']:
        ...
        model.update({"Connection, ConnectionX, ConnectionY, ConnectionZ, ConnectionAzm, ConnectionDec, ConnectionGamma, ReleaseStage": \
                [["Vessel1", data['LazyWaveCatenaryDefinition']['Hangoff']['from_midship'], data['LazyWaveCatenaryDefinition']['Hangoff']['from_centerline'], data['LazyWaveCatenaryDefinition']['Hangoff']['above_keel'], data['simpleCatenaryDefinition']['lay_azimuth_to_vessel'],
                  180-data['simpleCatenaryDefinition']['declinationAngle'], data['FEASettings']['EndOrientation']['SCR']['A']['Gamma'], "~"], \
                ["Anchored", (distance_from_hangoff_to_TDP)*math.cos(math.radians(absolute_orientation_angle_of_riser)) + data['LazyWaveCatenaryDefinition']['Hangoff']['from_midship']
                    , data['LazyWaveCatenaryDefinition']['Hangoff']['from_centerline'] + distance_from_hangoff_to_TDP*math.sin(math.radians(absolute_orientation_angle_of_riser)), \
                data['MainPipe']['InsulationSection']['OD']*0.0254/2, data['simpleCatenaryDefinition']['lay_azimuth_to_vessel'],
                 data['FEASettings']['EndOrientation']['SCR']['B']['Declination'],
                 data['FEASettings']['EndOrientation']['SCR']['B']['Gamma'], "~"]]})
    
    model.update({"ConnectionStiffnessX, ConnectionStiffnessY": [[data['FEASettings']['FlexJointStiffness']['ConnectionLabel'], data['FEASettings']['FlexJointStiffness']['ConnectionLabel']], [0, "~"]]})
    ...
    if data['default']['Analysis']['SLWR']:
        ...
        if SLWR_L_Before_tdp > 0:
            model.update({"LineType, Length, TargetSegmentLength": \
                        [["FJExtension1", data['LazyWaveCatenaryDefinition']['TaperJoint']['L'], data['FEASettings']['Mesh']['Top']['Size']], \
                        ["MainPipe", 2, data['FEASettings']['Mesh']['Top']['Size']], \
                        ["MainPipe", 2, data['FEASettings']['Mesh']['Top']['Size']*2], \
                        ["MainPipe", data['FEASettings']['Mesh']['Top']['L']-data['LazyWaveCatenaryDefinition']['TaperJoint']['L'] -4, data['FEASettings']['Mesh']['Top']['Size']*2*2], \
                        ...
                        ["MainPipe", data['LazyWaveCatenaryDefinition']['TDPToAnchor'] -30 -data['FEASettings']['Mesh']['AfterTDP']['L'], 20]]})
        else:
            model.update({"LineType, Length, TargetSegmentLength": \
                        [["FJExtension1", data['LazyWaveCatenaryDefinition']['TaperJoint']['L'], data['FEASettings']['Mesh']['Top']['Size']], \
                        ["MainPipe", 2, data['FEASettings']['Mesh']['Top']['Size']], \
    ...
    if data['default']['Analysis']['SCR']:
        model.update({"LineType, Length, TargetSegmentLength": \
                    [["FJExtension1", data['LazyWaveCatenaryDefinition']['TaperJoint']['L'], data['FEASettings']['Mesh']['Top']['Size']], \
                     ...
                     ["MainPipe", 2, data['FEASettings']['Mesh']['Top']['Size'] * 2], \
                     ["MainPipe",
                      data['FEASettings']['Mesh']['Top']['L'] - data['LazyWaveCatenaryDefinition']['TaperJoint'][
                    ...
                    ["MainPipe", 10, data['FEASettings']['Mesh']['AfterTDP']['Size']*8], \
                    ["MainPipe", 10, data['FEASettings']['Mesh']['AfterTDP']['Size']*16], \
                    ["MainPipe", data['simpleCatenaryDefinition']['TDPToAnchor'] -30 - data['FEASettings']['Mesh']['AfterTDP']['L'], 20]]})
    ...
    model.update({"ContentsPressureRefZ": -data['LazyWaveCatenaryDefinition']['HangoffBelowMeanSeaLevel']})
    model.update({"ContentsPressure": data['FEASettings']['DesignPressure']['Surface']*6.894745})
    ...
    model.update({"LayAzimuth": data['LazyWaveCatenaryDefinition']['lay_azimuth_to_vessel']+ 180})
...
def VariableData(data):
    ...
    for i in range(0, len(data)):
        if data[i]["Type"]=="BendingConnectionStiffness":
            ...
            model["BendingConnectionStiffness"].append(BendingConnectionStiffness(data[i]))
...
def LineTypeOuterDiameter(data):
    ...
    model.update({"Name": data['Name']})
    model.update({"IndependentValue, DependentValue": [[0, data['ThickEndOD']],[data['ProfileLength'], data['ThinEndOD']]]})
...
def build_model(FEAType, cfg):
    if cfg['default']['Analysis']['SLWR']:
        for LoadingIndex in range (0, len(cfg['EnvironmentLoad'][FEAType])):
            cfg['Analysis']['fe_filename'] = cfg['Analysis']['fe_folder'] + cfg['Analysis']['file_name'] + '_SLWR_FE_' + cfg['EnvironmentLoad'][FEAType][LoadingIndex]['Wave']['WaveTrains'][0]['Name'] + '.yml'
            if cfg['default']['Analysis'][FEAType] == True:
                FEAmodel1, FEAmodel2 = orcaflexModel(cfg, FEAType, LoadingIndex)
                if FEAType == 'Extreme':
                    WriteOrcaflexModel([FEAmodel1, 'dataManager\\catenary\\VesselTypes_Extreme.yml', FEAmodel2], cfg)
                elif FEAType == 'Fatigue':
                    WriteOrcaflexModel([FEAmodel1, 'dataManager\\catenary\\VesselTypes_Fatigue.yml', FEAmodel2], cfg)

        saveDataYaml(cfg, cfg['Analysis']['result_folder'] + cfg['Analysis']['file_name'], False)

    if cfg['default']['Analysis']['SCR']:
        for LoadingIndex in range (0, len(cfg['EnvironmentLoad'][FEAType])):
            cfg['Analysis']['fe_filename'] = cfg['Analysis']['fe_folder'] + cfg['Analysis']['file_name'] + '_SCR_FE_' + cfg['EnvironmentLoad'][FEAType][LoadingIndex]['Wave']['WaveTrains'][0]['Name'] + '_FE.yml'
            if cfg['default']['Analysis'][FEAType] == True:
                FEAmodel1, FEAmodel2 = orcaflexModel(cfg, FEAType, LoadingIndex)
                if FEAType == 'Extreme':
                    WriteOrcaflexModel([FEAmodel1, 'dataManager\\catenary\\VesselTypes_Extreme.yml', FEAmodel2], cfg)
