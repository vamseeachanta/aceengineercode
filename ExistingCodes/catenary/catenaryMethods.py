...
def buoyancyProperties(cfg):

    if cfg["LazyWaveCatenaryDefinition"]["UniformBuoyancy"]["Thickness"] != None:
        cfg = pipeProperties(cfg, FluidDensity=cfg['Material']['Fluid']['Rho'], Buoyancy = True)
        ...
        BuoyancyOD = math.sqrt(2*cfg['catenaryResult']['FluidFilled']['weightPerUnitLength']/9.81*4/math.pi/(cfg['Material']['SeaWater']['Rho'] \
    ...
    DiscreteBuoyancyOD = math.sqrt(100/cfg['LazyWaveCatenaryDefinition']['DiscreteBuoyancy']['BuoyancyCoverage'] * BuoyancyOD**2 - cfg['InsulationSection']['OD']**2)
    cfg['LazyWaveCatenaryDefinition']['DiscreteBuoyancy']['Thickness'] = DiscreteBuoyancyOD
