...
workbook = xlrd.open_workbook('results\\Non_Linear_Stress_Strain_Ratio\\0159-ANL-0001-01 (120 ksi Non Linear Stress Strain Curve) (Released).xlsx')  # Open Excel file 
...
plt.tight_layout()
plt.savefig('results\\Non_Linear_Stress_Strain_Ratio\\Non-Linear Stress Strain Cruve.png')
plt.show()
