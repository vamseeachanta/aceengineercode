...
print("The value of ratios is",x1,x2,c,x3,x4,x5)
...
ηsx_simp=σI_xx/σscrx_simp
FALSE=σI_yy/σscry_simp
ηsz_simp=τ_I/σscrz_simp
...
ηux_simp=σI_xx/σucrx_simp1
ηuy_simp=σI_yy/σucry_simp2
ηuz_simp=τ_I/σucrz_simp1
...
ηsx_side=σI_xx/σscrx_side
ηsy_side=σI_yy/σscry_side
ηsz_side=τ_I/σscrz_side
...
ηux_side=σI_xx/σucrx_side1
ηuy_side=σI_yy/σucry_side2
ηuz_side=τ_I/σucrz_side1
...
σy_rd=σy_R/ϒ_M
print(λ_c,µ,k1,k2,k3,k4_I,p_Sd_pa,p_Sd_ksi,x12,ϒ_M,σy_R,σy_rd)
...
print("the ϒ_M & τrd values is",ϒ_M,τ_rd)
...
print("The value of ϒM & τrd is",ϒM,τrd)

σ_xrd=σxrd
σ_yrd=σy_rd
τ_rd=τrd
x15=(σI_xx/σ_xrd)**2+(σI_yy/σ_yrd)**2-ci_2*(σI_yy/σ_xrd)*(σI_yy/σ_yrd)+(τ_I/τ_rd)**2
     
print("The value of DESGIN RESISTANCE longitudinal stress &  transverse stress,Shear stress in plate",σ_xrd,σ_yrd,τ_rd,x15)


# DNV-RP-C201 Usage factor

Longitudinal=σI_xx/σxrd
Transverse=σI_yy/σy_rd
Shear=τ_I/τ_rd
Biaxial=sqrt(x15)
