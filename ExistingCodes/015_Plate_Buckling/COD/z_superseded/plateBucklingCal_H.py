...
x10=0.000145038      #H7
x11=0.001            #H8
p_Sd_pa=101325+1025*D*x9
p_Sd_ksi=p_Sd_pa*x10*x11
x12= 2*(x3**2)*f       #x7=2*(t/s)^2*f_y
...
Kp1=1
Kp2=1-h_α2*((p_Sd_ksi/f)-2*x3**2)
if(p_Sd_ksi<=p_Sd_pa):
    print(" The value of Kp is",Kp1)
else:
    print(" The value of Kp is",Kp2)
ϒ_M=1.15
σy_R=(1.3*t/l*sqrt(E/f)+k4*(1-1.3*t/l*sqrt(E/f)))*f*Kp1
σy_rd=σy_R/ϒ_M
print(λ_c,µ,k1,k2,k3,k4,p_Sd_pa,p_Sd_ksi,x12,ϒ_M,σy_R,σy_rd)
...
τrd=C_τe2/ϒM*f/sqrt(3)
print("The value of ϒM & τrd is",ϒM,τrd)

σ_xrd=σxrd
σ_yrd=σy_rd
τ_rd=τrd
x15=(σ_xx/σ_xrd)**2+(σ_yy/σ_yrd)**2-ci_2*(σ_yy/σ_xrd)*(σ_yy/σ_yrd)+(τ/τ_rd)**2
     
print("The value of DESGIN RESISTANCE longitudinal stress &  transverse stress,Shear stress in plate",σ_xrd,σ_yrd,τ_rd)


# DNV-RP-C201 Usage factor

Longitudinal=σ_xx/σxrd
Transverse=σ_yy/σy_rd
Shear=τ/τ_rd
Biaxial=sqrt(x15)
