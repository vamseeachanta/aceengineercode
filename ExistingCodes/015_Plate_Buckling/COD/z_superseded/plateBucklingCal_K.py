...
ηsx_simp=σK_xx/σscrx_simp
FALSE=σK_yy/σscry_simp
ηsz_simp=τ_K/σscrz_simp
...
ηux_simp=σK_xx/σucrx_simp1
ηuy_simp=σK_yy/σucry_simp2
ηuz_simp=τ_K/σucrz_simp1
...
ηsx_side=σK_xx/σscrx_side
ηsy_side=σK_yy/σscry_side
ηsz_side=τ_K/σscrz_side
...
ηux_side=σK_xx/σucrx_side1
ηuy_side=σK_yy/σucry_side2
ηuz_side=τ_K/σucrz_side1
...
σy_rd=σy_R/ϒ_M
print(λ_c,µ,k1,k2,k3,k4_K,p_Sd_pa,p_Sd_ksi,x12,ϒ_M,σy_R,σy_rd)
...
σ_yrd=σy_rd
τ_rd=τrd
x15=(σK_xx/σ_xrd)**2+(σK_yy/σ_yrd)**2-ci_2*(σK_yy/σ_xrd)*(σK_yy/σ_yrd)+(τ_K/τ_rd)**2
...
Longitudinal=σK_xx/σxrd
Transverse=σK_yy/σy_rd
Shear=τ_K/τ_rd
Biaxial=sqrt(x15)
