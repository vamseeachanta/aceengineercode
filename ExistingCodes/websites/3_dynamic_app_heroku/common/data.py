class ReadData():
    ...
    def from_xlsx(self, cfg, file_index=0):
        #TODO Define sample cfgs so it is easy to replicate. Utilize these cfgs as test and define them immediately above.
    ...
    def from_xlsx_get_line_number_containing_keyword(self, cfg):
        ...
        keyword_row_number = self.WorkSheetRowNumberWithText(sh, cfg["key_words"])
    ...
    def superseded_xlsx_to_df_by_keyword_search(self, data):
        ...
        KeyWordRowNumber = self.WorkSheetRowNumberWithText(sh, data["KeyWords"])
    ...
    def WorkSheetRowNumberWithText(self, sh, KeyWordArray):
        rownum = None
    ...
    def read_yml_file(self, data):
        ...
        with open(data['io'], 'r') as ymlfile:
            data_as_dictionary = yaml.load(ymlfile)
    ...
    def get_file_list_from_folder(self, folder_with_file_type):
